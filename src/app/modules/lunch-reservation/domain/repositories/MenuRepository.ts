...
import { MenuVariation, VariationType } from "../entities/MenuVariation"
...
export interface CreateMenuVariationDTO {
  menuId: string
...
export interface MenuRepository {
  ...
  createVariation(variationData: CreateMenuVariationDTO): Promise<MenuVariation>
}
