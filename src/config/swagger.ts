export const swaggerDocument = {
  ...
  paths: {
    ...
    "/api/lunch-reservation/admin/reservations/{id}/status": {
      put: {
        tags: ["Reservations"],
        summary: "Atualizar status de uma reserva (ADMIN)",
        description:
          "Permite que o administrador ative ou cancele qualquer reserva no sistema. Apenas os status ACTIVE e CANCELLED são permitidos. Requer privilégios de administrador (ADMIN).",
        security: [
          {
            BearerAuth: [],
          },
              ...
              schema: {
                ...
                properties: {
                  status: {
                    ...
                    enum: ["ACTIVE", "CANCELLED"],
                    description:
                      "Novo status da reserva (ACTIVE para ativar, CANCELLED para cancelar)",
                  },
                },
                required: ["status"],
              },
            ...
            content: {
              "application/json": {
                ...
                example: {
                  ...
                  menuVariationId: "880e8400-e29b-41d4-a716-446655440003",
                  reservationDate: "2025-12-10T00:00:00.000Z",
                  status: "ACTIVE",
                  isAutoGenerated: false,
